...
import com.gideon.abiri.Helpers.DirectionJSONParser;
import com.gideon.abiri.Interfaces.IFCMService;
...
public class DriverTracking extends AppCompatActivity implements OnMapReadyCallback , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
        ...
        btnStartTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(btnStartTrip.getText().equals("START TRIP")){
                    ...
                    calculateCashFee(pickupLocation, new LatLng(Common.currentLat, Common.currentLng));
                }
            }
        });
        getRiderData();
    ...
    private void calculateCashFee(final LatLng pickupLocation, LatLng latLng) {
